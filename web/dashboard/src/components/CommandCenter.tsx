  ...
  return <div className="cc-shell">
    ...
    <div className="cc-main">
      ...
      <main className="cc-content">
        ...
        <section id="participation" className="cc-section"><SectionTitle index="04" title="原 participation · 前瞻验证" detail="保留原独立账本；下方 A/B/C/D 使用另一个实验身份。" aside={<span className="cc-small-badge cc-paper-badge"><FlaskConical size={13} /> 模拟资金</span>} />
          ...
          <ReviewComparison data={command?.review_comparison} unavailable={commandStale} />
