  ...
  return <div className="cc-shell">
    ...
    <div className="cc-main">
      ...
      <main className="cc-content">
        ...
        <section id="participation" className="cc-section"><SectionTitle index="04" title="模拟账户与新方向" detail="旧实验保留为历史证据；当前只运行 BTC/ETH 日线趋势验证。" aside={<span className="cc-small-badge cc-paper-badge"><FlaskConical size={13} /> 模拟资金</span>} />
