...
export function ShadowMLPanel({ shadowML }: ShadowMLPanelProps) {
  if (!shadowML || !shadowML.available) {
    return (
      <div className="liquid-glass-inset tone-neutral reading-frame p-5 flex flex-col gap-4">
  ...
  return (
    <div className="liquid-glass-inset tone-neutral reading-frame p-5 flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="liquid-glass-thin tone-coral p-3 text-center">
          <div className="text-xs text-[var(--text-dim)]">本轮</div>
          <div className="text-lg font-semibold">
            {lastStep.delta_bps != null ? `${fmtNum(lastStep.delta_bps, 1)} 基点` : '--'}
          </div>
        </div>
        <div className="liquid-glass-thin tone-amber p-3 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="liquid-glass-inset tone-sage p-4">
        ...
        <div className="liquid-glass-inset tone-rose p-4">
