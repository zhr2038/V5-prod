...
30 minutes. qyun2's 10-minute telemetry sync safely no-ops when there is no new
completed bundle; the lower export cadence bounds duplicate archive growth while
still publishing twice inside each hourly trading interval.
