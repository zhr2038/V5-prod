...
def _finish_roundtrip(
    ...
    *,
    ...
    row = {
        ...
        "entry_fee_usdt_applied_to_net": cost["entry_fee_usdt_applied_to_net"],
        "entry_base_fee_reflected_in_exit_qty": cost["entry_base_fee_reflected_in_exit_qty"],
        "entry_base_fee_ledger_adjustment_usdt": cost["entry_base_fee_ledger_adjustment_usdt"],
        "entry_has_fill_rows": cost["entry_has_fill_rows"],
        "exit_has_fill_rows": cost["exit_has_fill_rows"],
        "entry_has_fill_evidence": cost["entry_has_fill_evidence"],
        "exit_has_fill_evidence": cost["exit_has_fill_evidence"],
