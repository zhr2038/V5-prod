    ...
    def enrich_orders_with_cost(
        ...
        for idx, order in enumerate(source):
            ...
            row = {
                ...
                "expected_gross_return_bps": gate.expected_gross_return_bps,
                "expected_net_return_bps": gate.expected_net_return_bps,
                "roundtrip_cost_bps": gate.roundtrip_cost_bps,
                "horizon": gate.horizon,
                "cost_basis": gate.cost_basis,
                "forecast_version": gate.forecast_version,
