...
GENERIC_PAPER_REPORT_FIELDS = {
    "paper_strategy_registry.csv": (
        ...
        "cohort_id", "cohort_version", "cohort_observation_start_at",
        "cohort_status", "cohort_proposal_content_snapshot_sha256",
    ),
    "paper_strategy_registry_current.csv": (),
    "paper_strategy_registry_history.csv": (),
    "paper_strategy_trackers_current.csv": (),
    "paper_strategy_state.csv": (
        ...
        "source_proposal_content_snapshot_id",
        "source_proposal_content_snapshot_sha256",
        "proposal_content_snapshot_sha256", "cohort_id", "cohort_version",
        "cohort_observation_start_at", "entry_signal_ts", "entry_decision_ts",
        "opened_at", "closed_at", "cohort_scope", "canonical_opportunity_id",
        "evidence_independence_weight", "entry_arrival_mid", "entry_bid",
        "entry_ask", "cost_source", "cost_trust_level", "market_regime",
    ),
