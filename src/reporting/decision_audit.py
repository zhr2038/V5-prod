...
class DecisionAudit:
    ...
    counts: Dict[str, int] = field(default_factory=lambda: {
        ...
        "market_impulse_probe_quality_filter_block_count": 0,
        ...
        "protect_alt_short_cycle_negative_expectancy_count": 0,
        ...
        "swing_hold_position_count": 0,
        "swing_min_hold_guard_count": 0,
