...
def _candidate_price_observability(
    *,
    ...
    quote_ts = _first(
        ...
        _nested_get(lifecycle, ("arrival_quote_ts",)),
        _nested_get(lifecycle, ("book_ts",)),
        _nested_get(order_meta, ("quote_ts",)),
        _nested_get(order_meta, ("arrival_quote_ts",)),
        _nested_get(order_meta, ("book_ts",)),
        _nested_get(top, ("quote_ts",)),
        _nested_get(top, ("arrival_quote_ts",)),
        _nested_get(top, ("book_ts",)),
        _nested_get(explain, ("quote_ts",)),
        _nested_get(explain, ("arrival_quote_ts",)),
        _nested_get(explain, ("book_ts",)),
    ...
    quote_age_ms = _first_float(
        ...
        _nested_get(lifecycle, ("arrival_quote_age_ms",)),
        _nested_get(lifecycle, ("book_age_ms",)),
        _nested_get(order_meta, ("quote_age_ms",)),
        _nested_get(order_meta, ("arrival_quote_age_ms",)),
        _nested_get(order_meta, ("book_age_ms",)),
        _nested_get(top, ("quote_age_ms",)),
        _nested_get(top, ("arrival_quote_age_ms",)),
        _nested_get(top, ("book_age_ms",)),
        _nested_get(explain, ("quote_age_ms",)),
        _nested_get(explain, ("arrival_quote_age_ms",)),
        _nested_get(explain, ("book_age_ms",)),
    ...
    quote_source = _first(
        ...
        _nested_get(lifecycle, ("arrival_quote_source",)),
        _nested_get(lifecycle, ("book_source",)),
        _nested_get(order_meta, ("quote_source",)),
        _nested_get(order_meta, ("arrival_quote_source",)),
        _nested_get(order_meta, ("book_source",)),
        _nested_get(top, ("quote_source",)),
        _nested_get(top, ("arrival_quote_source",)),
        _nested_get(top, ("book_source",)),
        _nested_get(explain, ("quote_source",)),
        _nested_get(explain, ("arrival_quote_source",)),
        _nested_get(explain, ("book_source",)),
    ...
    if arrival_mid is not None and arrival_mid > 0:
        return {
            ...
            "quote_source": quote_source or "top_of_book",
