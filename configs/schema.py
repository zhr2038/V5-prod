...
class ExecutionConfig(BaseModel):
    ...
    probe_ignore_normal_zero_target_close: bool = Field(default=True)
    probe_min_hold_hours_before_zero_target_close: int = Field(default=4, ge=0, le=24 * 30)
    probe_allow_zero_target_close_on_risk_off: bool = Field(default=True)
    probe_allow_zero_target_close_on_hard_negative_expectancy: bool = Field(default=False)
    ...
    swing_hold_enabled: bool = Field(default=True)
    swing_min_hold_hours: int = Field(default=24, ge=0, le=24 * 30)
    swing_apply_only_to_normal_entry: bool = Field(default=True)
    swing_require_alpha6_confirmed: bool = Field(default=True)
    swing_min_alpha6_score: float = Field(default=0.50, ge=-10.0, le=10.0)
    swing_min_f5_rsi: float = Field(default=0.30, ge=-10.0, le=10.0)
    swing_min_f4_volume: float = Field(default=0.0, ge=-10.0, le=10.0)
    swing_block_f3_dominant_enabled: bool = Field(default=True)
    swing_f3_dominant_max_contribution_pct: float = Field(default=0.50, ge=0.0, le=1.0)
    swing_f3_dominant_require_f4_min: float = Field(default=0.50, ge=-10.0, le=10.0)
    swing_f3_dominant_require_f5_min: float = Field(default=0.45, ge=-10.0, le=10.0)
    swing_ignore_normal_zero_target_close_before_min_hold: bool = Field(default=True)
    ...
    swing_atr_early_exit_guard_enabled: bool = Field(default=True)
    swing_atr_early_exit_guard_before_min_hold: bool = Field(default=True)
    swing_atr_early_exit_min_loss_net_bps: float = Field(default=-80.0, ge=-10000.0, le=10000.0)
    swing_atr_early_exit_allow_if_f5_turns_negative: bool = Field(default=True)
    swing_atr_early_exit_f5_floor: float = Field(default=-0.30, ge=-10.0, le=10.0)
    swing_atr_early_exit_allow_if_risk_off: bool = Field(default=True)
    ...
    swing_min_hold_exit_guard_enabled: bool = Field(
        default=True,
